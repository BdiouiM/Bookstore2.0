...
public interface LivreRepository extends JpaRepository<Livre, Long>{
	...
	List<Livre> afficherLivresSelonID(@Param("id") Long id);
     ...
     @Modifying
     @Transactional
     @Query(value="DELETE FROM T_Livre WHERE T_Livre.id=:id ", nativeQuery = true)
 	void supprimerLivre(@Param("id") Long id);
  ...
  //sans JPQL
	...
	void modifierLivre(@Param("id") long idL, @Param("auteur") String auteur, @Param("genre") GenreLivre genre, @Param("nbrPages") int nbrPages, @Param("prix") float prix, @Param("titre") String titre);
